...
cr<- ggplot()+geom_line(data=hi, aes(variable, value, group= code, color=group), size=1.3)+ geom_line(data=bo2, aes(variable, value, group=interaction(code,group), color= group), size=0.6)+scale_color_manual(values=(c("black", "#ec9032", "#a8dd76", "#66d4c6", "#f6a0d0", "#ffcc5c")))+facet_wrap(~code)+theme_classic()+theme(legend.position="top")


cr<- ggplot()+ geom_line(data=bo2, aes(variable, value, group=interaction(code,group), color= group), size=0.8)+geom_line(data=hi, aes(variable, value, group= code, color=group))+scale_color_manual(values=(c("black", "#ec9032", "#a8dd76", "#66d4c6", "#f6a0d0", "#ffcc5c")))+facet_wrap(~code)+theme_classic()+theme(legend.position="top")
